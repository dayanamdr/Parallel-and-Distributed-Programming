...
public class MultiplyByColumnRunnable implements Runnable {
    ...
    public MultiplyByColumnRunnable(Matrix a, Matrix b, Matrix c, int capacity, int startRowIdx, int startColIdx) {
        this.a = a;
        this.b = b;
        this.c = c;
